/*
	board_definition.cpp - board definition file for the NUCLEO-F103RB board.
	
	MCU: STM32F103RB
	
	2021/06/05, Alan Ford
*/
...
bool init() {
	...
	usart.usart = USART_1;
	usart.configs = 1;
	usartTxDef[0] = { .port = GPIO_PORT_A, .pin = 9, .af = 0 };
	// usartTxDef[1] = { .port = GPIO_PORT_B, .pin = 6, .af = 0 };
	usart.tx = usartTxDef;
	usartRxDef[0] = { .port = GPIO_PORT_A, .pin = 10, .af = 0 };
	...
	usart.usart = USART_2;
	usart.configs = 1;
	usartTxDef[0] = { .port = GPIO_PORT_A, .pin = 2, .af = 0 };
	// usartTxDef[1] = { .port = GPIO_PORT_B, .pin = 14, .af = 1 };
	usart.tx = usartTxDef;
	usartRxDef[0] = { .port = GPIO_PORT_A, .pin = 3, .af = 0 };
